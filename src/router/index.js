...
export const asyncRoutes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'collect',
        meta: {
          perms: ['GET /admin/collect/collectList'],
          title: '会员收藏',
          noCache: true
        }
      },
...

  {
    ...
    children: [
      ...
      {
        path: 'orderGoods',
        component: () => import('@/views/mall/orderGoods'),
        name: 'orderGoods',
        meta: {
          perms: [],
          title: '退款管理',
...

  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'category',
        meta: {
          perms: ['GET /admin/category/query', 'POST /admin/category/update', 'POST /admin/category/delete', 'POST /admin/category/insert'],
          title: '商品类目管理',
          noCache: true
        }
      },
