<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.value" clearable style="width: 200px" class="filter-item" placeholder="请选择用途">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row>
      ...
      <el-table-column align="center" min-width="100px" label="用途" prop="value" >
        <template slot-scope="scope">
          <el-tag >{{ returnValue(scope.row.value) }}</el-tag>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="dataForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="用途" prop="value">
          <el-select v-model="dataForm.value" placeholder="请选择用途">
<!--            <el-option v-for="(key, value) in statusMap" :key="key" :label="key" :value="value" />-->
            <el-option :value="0" label="其他" />
            <el-option :value="1" label="搜索关键词" />
            <el-option :value="2" label="评价关键词" />
            <el-option :value="3" label="评论关键词" />
            <el-option :value="4" label="退款关键词" />
          </el-select>
        </el-form-item>
