<template>
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-form ref="goods" :rules="rules" :model="goods" label-width="150px">
        <el-form-item label="商品编号" prop="goodsSn">
          <el-input v-model="goods.goodsSn" disabled placeholder="无需输入，自动生成" style="width: 300px;"/>
        </el-form-item>
    ...
    <div class="op-container">
      ...
      <el-button type="primary" :disabled="publishFlag" @click="handlePublish">上架</el-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    handlePublish: function() {
      ...
      publishGoods(this.goods).then(response => {
        this.$notify.success({
          title: '成功',
          message: '创建成功'
        })
